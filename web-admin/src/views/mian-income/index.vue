    ...
    <el-form :model="info"
      ...
      { required: true, message: '请输入店铺名称', trigger: 'blur' }
        ...
        <el-input v-model="info.name"
                  placeholder="添加类别"></el-input>
      </el-form-item>
      <el-form-item>
        <el-button type="primary"
                   @click="saveName">保存</el-button>
      </el-form-item>
    </el-form>
    <el-form :model="info"
             :inline="true"
      ...
      { required: true, message: '请输入公告信息', trigger: 'blur' }
        ...
        <el-input v-model="info.announcement"
                  type="textarea"
                  :rows="2"
                  placeholder="公告"></el-input>
      </el-form-item>
      <el-form-item>
        <el-button type="primary"
                   @click="saveAnnouncement">保存</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
...
export default {
  ...
  data () {
    ...
    return {
      ...
      imageUrl: '',
      actionUrl: (process.env.NODE_ENV !== 'production' ? '/proxyApi' : process.env.API_ROOT) + '/info/upload',
      headers: {
